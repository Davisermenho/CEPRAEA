...
> **Política:** toda ação relevante deve atualizar este arquivo no mesmo commit ou no imediatamente subsequente. Não registrar valores sensíveis de ambiente.
*Última atualização*: 2026-05-06 - 03:26 BRT - Claude Sonnet 4.6 (`Copilot) ---
