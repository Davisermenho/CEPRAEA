...
|------|------------|----|-----------|-----------------------|
| 2026-05-21 | 23:38 | CEPR-GOV-HARDENING-05 | PR operacional formal de modo solo criada e ruído de CI reduzido: `npm ci` dos gates Scout passou a usar `--loglevel=error --no-audit --no-fund` para suprimir warnings deprecados de dependências transitivas | `docs/auditorias/solo-mode-governance-2026-05-21.md` criado · `.github/workflows/scout-preview-smoke.yml` e `.github/workflows/scout-contract-cepr0098d.yml` atualizados · branch protection snapshot registrado |
