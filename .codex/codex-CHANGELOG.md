...
|------|------------|----|-----------|-----------------------|
| 2026-05-21 | 07:06 | CEPR-0098D-PREVIEW-ENV | Corrigido `VITE_SUPABASE_TEAM_ID` no Preview branch-specific da PR #18 e redeployado sem usar worktree local sujo | `vercel env add VITE_SUPABASE_TEAM_ID preview feat/scout-required-fields-flow-contract --force --yes` ✅ · `vercel redeploy ... --target preview` ✅ (`Ready`) · Preview `https://cepraea-84ewy03rp-davi-sermenhos-projects.vercel.app` · smoke ✅ (`4 passed`) · bundle contem o `team_id` correto |
